...
SURF_SPOTS_CONFIG = {
    ...
    "翡翠灣": {
        "category":     "🔵 北部",
        "offshore_wind": ["南", "東南"],
        "safety_note":  "私人海灣，注意潛水區域劃分，西側礁岩勿靠近",
    },
    # ── 宜蘭 ──────────────────────────────────────────────────
    "宜蘭外澳": {
        "category":     "🟢 宜蘭",
        "offshore_wind": ["西", "西南", "南"],
        "safety_note":  "注意防波堤旁可能產生的離岸流",
    },
    "烏石港": {
        "category":     "🟢 宜蘭",
        "offshore_wind": ["西", "西南", "南"],
        "safety_note":  "港口防波堤北側礁岩區，注意退流",
    },
    # ── 中部 ──────────────────────────────────────────────────
    "台中松柏港": {
        "category":     "🟡 中部",
    ...
    "花蓮北濱公園": {
        ...
        "safety_note":  "礫石灘，退潮時暗礁多，注意強離岸流",
    },
    "花蓮環保公園": {
        "category":     "🟠 東部｜花蓮",
        "offshore_wind": ["西", "西北", "西南"],
        "safety_note":  "礫石底質，浪崩快，注意判斷下浪時機",
    },
    # ── 東部（台東）────────────────────────────────────────────
    "台東金樽": {
        "category":     "🟠 東部｜台東",
        "offshore_wind": ["西", "西北", "西南"],
        "safety_note":  "礁岩型浪點，退潮大石裸露，建議有經驗者入水",
    },
    "台東東河": {
        "category":     "🟠 東部｜台東",
        "offshore_wind": ["西", "西北", "西南"],
        "safety_note":  "橋下為熱門衝浪區，沙礫混合底質，注意人潮與流向",
    },
    # ── 南部 ──────────────────────────────────────────────────
    "台南漁光島": {
        "category":     "🔴 南部",
